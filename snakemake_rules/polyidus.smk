...
rule polyidus:
	...
	params:
		...
		host_idx = lambda wildcards, input: path.splitext(path.splitext(input.host_idx[0])[0])[0],
		virus_idx = lambda wildcards, input: path.splitext(path.splitext(input.virus_idx[0])[0])[0],
	resources:
